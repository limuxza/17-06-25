...
local Notification = Linux.Instance("Frame", {
    ...
    BorderColor3 = Color3.fromRGB(80, 40, 50),
    BorderSizePixel = 0,
...
Linux.Instance("UIStroke", {
    Parent = Notification,
    Color = Color3.fromRGB(120, 60, 80),
    Thickness = 1
})
...
if config.SubContent then
    Linux.Instance("TextLabel", {
        ...
        TextColor3 = Color3.fromRGB(200, 160, 180),
        TextSize = 12,
        TextWrapped = true,
        TextXAlignment = Enum.TextXAlignment.Left,
        TextYAlignment = Enum.TextYAlignment.Top,
...
local ProgressBar = Linux.Instance("Frame", {
    Parent = Notification,
    BackgroundColor3 = Color3.fromRGB(30, 15, 20),
...
local TopBar = Linux.Instance("Frame", {
    Parent = Main,
    BackgroundColor3 = Color3.fromRGB(50, 30, 35),
    BorderColor3 = Color3.fromRGB(80, 40, 50),
    BorderSizePixel = 0,
...
Linux.Instance("UIGradient", {
    Parent = TopBar,
    Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0, Color3.fromRGB(70, 40, 50)),
        ColorSequenceKeypoint.new(1, Color3.fromRGB(50, 30, 40))
    }),
    Rotation = 90
})
...
Linux.Instance("UIGradient", {
    Parent = TabsBar,
    Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0, Color3.fromRGB(55, 35, 40)),
        ColorSequenceKeypoint.new(1, Color3.fromRGB(35, 20, 25))
    }),
    Rotation = 90
})
...
function LinuxLib.Tab(config)
    ...
    Linux.Instance("UIGradient", {
        Parent = TabBtn,
        Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0, Color3.fromRGB(60, 35, 45)),
            ColorSequenceKeypoint.new(1, Color3.fromRGB(40, 25, 35))
        }),
        Rotation = 90
    })
    ...
    if config.Icon and config.Enabled then
        TabIcon = Linux.Instance("ImageLabel", {
            ...
            Image = config.Icon,
            ImageColor3 = Color3.fromRGB(180, 140, 160),
            ZIndex = 2
        })
    end
    ...
    local TabText = Linux.Instance("TextLabel", {
        ...
        Font = Enum.Font.GothamSemibold,
        Text = config.Name,
        TextColor3 = Color3.fromRGB(180, 140, 160),
        TextSize = 14,
        TextXAlignment = Enum.TextXAlignment.Left,
        ZIndex = 2
    })
    ...
    local Container = Linux.Instance("ScrollingFrame", {
        Parent = TabContent,
        BackgroundTransparency = 0,
        BackgroundColor3 = Color3.fromRGB(40, 22, 28),
    ...
    Linux.Instance("UIGradient", {
        Parent = Container,
        Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0, Color3.fromRGB(50, 28, 35)),
            ColorSequenceKeypoint.new(1, Color3.fromRGB(35, 20, 25))
        }),
        Rotation = 45
    })
    ...
    local function SelectTab()
        ...
        for _, tab in pairs(Tabs) do
            ...
            tab.Text.TextColor3 = Color3.fromRGB(180, 140, 160)
            tab.Button.BackgroundColor3 = Color3.fromRGB(50, 30, 35)
            tab.Button.BackgroundTransparency = 0
            tab.Button.BorderSizePixel = 1
            
            if tab.Icon then
                tab.Icon.ImageColor3 = Color3.fromRGB(180, 140, 160)
            end
        end
        ...
        TabBtn.BackgroundColor3 = Color3.fromRGB(70, 40, 50)
        TabBtn.BackgroundTransparency = 0
        TabBtn.BorderSizePixel = 1
        TabBtn.BorderColor3 = Color3.fromRGB(120, 60, 80)
    ...
    function TabElements.Button(config)
        ...
        Linux.Instance("UIGradient", {
            Parent = BtnFrame,
            Color = ColorSequence.new({
                ColorSequenceKeypoint.new(0, Color3.fromRGB(65, 35, 45)),
                ColorSequenceKeypoint.new(1, Color3.fromRGB(45, 25, 35))
            }),
            Rotation = 90
        })
        ...
        local BtnIcon = Linux.Instance("ImageLabel", {
            ...
            ImageColor3 = Color3.fromRGB(220, 180, 200),
            ZIndex = 2
        })
        ...
        Btn.MouseButton1Click:Connect(function()
            if not buttonClicked then
                buttonClicked = true
                TweenService:Create(BtnFrame, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(35, 20, 25)}):Play()
                task.wait(0.3)
                TweenService:Create(BtnFrame, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(55, 30, 40)}):Play()
                buttonClicked = false
            end
    ...
    function TabElements.Toggle(config)
        ...
        local function UpdateToggle(thisToggle)
            ...
            local thisCheckIcon = thisKnob and thisKnob:FindFirstChild("ImageLabel")
            
            if thisTrack and thisKnob and thisCheckIcon then
                ...
                if currentState then
                    ...
                    TweenService:Create(thisTrack, tween, {BackgroundColor3 = Color3.fromRGB(35, 20, 25)}):Play()
                    TweenService:Create(thisKnob, tween, {Position = UDim2.new(0, 2, 0.5, -7), BackgroundColor3 = Color3.fromRGB(220, 180, 200)}):Play()
            ...
            if IsOpen then
                for i, opt in pairs(Options) do
                    ...
                    local OptBtn = Linux.Instance("TextButton", {
                        ...
                        Font = Enum.Font.GothamSemibold,
                        Text = tostring(opt),
                        TextColor3 = isSelected and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(220, 180, 200),
                        TextSize = 14,
                        ZIndex = 3,
                        AutoButtonColor = false,
                        LayoutOrder = i
                    ...
                    OptBtn.MouseButton1Click:Connect(function()
                        if IsMulti then
                            ...
                            if index then
                                ...
                                OptBtn.TextColor3 = Color3.fromRGB(220, 180, 200)
                            else
    ...
    function TabElements.Slider(config)
        ...
        local ValueLabel = Linux.Instance("TextLabel", {
            Parent = Slider,
            BackgroundColor3 = Color3.fromRGB(50, 28, 35),
            BackgroundTransparency = 0,
    ...
    function TabElements.Input(config)
        ...
        local TextBox = Linux.Instance("TextBox", {
            ...
            PlaceholderColor3 = Color3.fromRGB(150, 100, 120),
            TextColor3 = Color3.fromRGB(255, 255, 255),
            TextSize = 12,
            TextScaled = false,
            TextTruncate = Enum.TextTruncate.AtEnd,
    ...
    function TabElements.Notification(config)
        ...
        Linux.Instance("UIGradient", {
            Parent = NotificationFrame,
            Color = ColorSequence.new({
                ColorSequenceKeypoint.new(0, Color3.fromRGB(55, 30, 40)),
                ColorSequenceKeypoint.new(1, Color3.fromRGB(35, 20, 25))
            }),
            Rotation = 90
        })
    ...
    function TabElements.Keybind(config)
        ...
        KeybindButton.MouseButton1Click:Connect(function()
            ...
            isCapturing = true
            KeybindButton.Text = "..."
            KeybindButton.TextColor3 = Color3.fromRGB(220, 180, 200)
    ...
    function TabElements.Colorpicker(config)
        ...
        local function CreateColorpickerPopup()
            ...
            Linux.Instance("UIGradient", {
                Parent = ColorpickerPopup,
                Color = ColorSequence.new({
                    ColorSequenceKeypoint.new(0, Color3.fromRGB(45, 25, 35)),
